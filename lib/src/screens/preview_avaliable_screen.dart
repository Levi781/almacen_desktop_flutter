...
class PreviewReportAvailableScreen extends StatelessWidget {
  const PreviewReportAvailableScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {

    final currentResult = Provider.of<ProductsService>(context).siproductos;
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          pw.Text('Reporte de todos los productos disponibles'),
          pw.SizedBox(height: 10),
